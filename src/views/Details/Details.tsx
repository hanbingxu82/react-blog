    ...
    return (
      <div>
        ...
        <div className={styles.box}>
          {/* 标题 */}
          <div className={styles.title}>ubuntu 从零搭建环境，部署项目</div>
          {/* 详情 */}
          <div className={styles.details}>从零开始搭建服务器环境的步骤</div>
          {/* 内容区 */}
          <div>
            <p>
              <strong>服务器上线</strong>
            ...
            #allow http https -A INPUT -p tcp --dport 443 -j ACCEPT -A INPUT -p tcp --dport 80 -j ACCEPT
            #allow ssh port login -A INPUT -p tcp -m state --state NEW --dport 39999 -j ACCEPT
          ...
          {/* 时间 */}
          <div className={styles.date}>2021-03-09</div>
        </div>
        {/* 底部备案号 */}
        <div>
